...
######################
        ...
        fname = "weights.epoch_{epoch:02d}.val_loss_{val_loss:.2f}.val_accuracy_{val_accuracy:.2f}.hdf5"
...
class FCNN_MultiOut:
    def __init__(self, input_shape, batch_size=32, n_epochs=100, n_classes=2,
                 loss="categorical_crossentropy", optimizer="adam", metrics=["accuracy"],
                 loss_weights=None,
                 out_dir="../trained_model/FCNN_MultiOut/"):
...
class ResNet:
    def __init__(self, input_shape, batch_size=32, n_epochs=100, n_classes=2,
                 n_resnet_units=3,
                 loss="categorical_crossentropy", optimizer="adam", metrics=["accuracy"],
                 out_dir="../trained_model/ResNet_MultiOut/"):
...
#        #############################
        ...
        fname = "weights.epoch_{epoch:02d}.val_loss_{val_loss:.2f}.val_accuracy_{val_accuracy:.2f}.hdf5"
        file_path = os.path.join(self.out_dir, fname)
        model_checkpoint = ModelCheckpoint(file_path, monitor='val_accuracy', save_best_only=False, period=5)
...
class MLSTM_FCN:
    ...
    def __init__(self, input_shape, batch_size=32, n_epochs=100, n_classes=2,
                 loss="categorical_crossentropy", optimizer="adam", metrics=["accuracy"],
                 loss_weights=None, out_dir="../trained_model/MLSTM_FCN/"):

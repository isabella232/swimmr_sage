...
class OnsetData(object):
    ...
    def __init__(self, useSML=False, northData=True, southData=False,\
                 ...
                 smlFname="./data/SOPHIE_expansion_phase_onsets_EPT90iso_without_dSMLequalsdSMU_1to6hrWaitingTimes.csv",smlDateRange=None,\
    ...
    def create_sml_bins(self, saveBinData=False,randomState=0,\
        ...
        smlDF = pandas.read_csv(self.smlFname,\
                            parse_dates=["Date_UTC"],date_parser=custom_date_parser)
        # rename the cols
